...
function PreviewContent() {
  ...
  return (
    <div className="bg-black text-white min-h-screen selection:bg-neutral-800 relative">
      ...
      {eventData?.is_audio_enabled !== false && (
        <FloatingAudioPlayer audioUrl={`${process.env.NEXT_PUBLIC_SUPABASE_URL}/storage/v1/object/public/assets/${eventId}/music.mp3`} autoPlay={wantsMusic} />
      )}
